...
apollo_config_db_url=jdbc:mysql://mysql-svc1:3306/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=root
apollo_config_db_password=123456

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://mysql-svc1:3306/ApolloPortalDB?characterEncoding=utf8
